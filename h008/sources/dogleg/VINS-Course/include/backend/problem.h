...
private:
    ...
    double GetChiSquaredNormL2();
    double GetXSquaredNormL2();
    ...
    double trust_delta=1e-2;
    double currentChi_;
    bool found = false;
    double epison_1 = 1e-15;
    double epison_2 = 1e-15;
    double epison_3 = 1e-20;
